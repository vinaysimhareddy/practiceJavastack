...
if (amazonMobileObjProperty.hasOwnProperty("rating")) {
    console.log("Rating Exist");
    console.table(amazonMobileObjProperty.rating);
}

if (amazonMobileObjProperty.hasOwnProperty("reviews")) {
    console.log("Reviews Exists");
    console.table(amazonMobileObjProperty.reviews);
}